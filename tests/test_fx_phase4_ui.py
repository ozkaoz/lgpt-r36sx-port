...
- the FxParamSpec table covers all 36 parameter ids exactly once per page
...
FX_PARAMS = [
    ...
    # REVERB (RC2 point 3.1: RVB MIX removed, wet-only reverb)
