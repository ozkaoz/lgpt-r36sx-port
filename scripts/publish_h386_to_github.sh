...
CORE_SHA256="71a518e8c0c8837acdff438ba355c81eeed59b05481fe9d9ddaace2f75367421"
...
publish() {
  ...
  gh release create "$TAG" \
    ...
    --repo "$GITHUB_REPO" \
    --title "LGPT R36SX H38.6 — Volumen lineal, VU en vivo, Rename en el menu de inicio, editor de texto unificado" \
