# BACON 1.5 Release Manifest — Golden Bootstrap
...
**ZIP:** `LGPT_R36SX_Bacon-1.5_SD_ROOT.zip` `7138546` `c5c77a0212e4784a9d0e6d0eddc4de1a8bbe0943b9ebef8b13a18a82a6b9cb1e` (56 files)
...
Physical PASS: LOCAL PASS / WINDOWS DETECT+PLAYBACK+RECORD PASS / SP404 DETECT+PLAYBACK PASS / ANDROID BRIDGE+PLAYBACK+RECORD PASS (no Runtime is not ready), core `46bd84` unchanged.

**ZIP contents:** `cubegm/cores/lgpt_core.so` (`46bd84`), `cubegm/lgpt` (`ee1ecfe53bf9c94915abc696271561b7ccbf157f9c80300438f720dbedad896c`), `cubegm/lgpt.elf` (`d5c467`), `cubegm/picoarch` (`93dbe7`), `frogui/core_overrides.txt`, `lgpt/otg/*` (daemons `0fc2bb7f`/`f71400`/`a96760`/`e1f910`/`3f0ea7`), `lgpt/otg/modules/*`, `lgpt/config.xml`, `VERSION.txt` (`46bd84ebb0d1b1be`), `SHA256SUMS.txt`

**Previous ZIP identities (historical, not current):** `31aa6d7e...` (7865366, docs stale), `71dc6b61...` (historical), `f3862cf5...` (7454962, pre-bootstrap). Current authoritative is `c5c77a0212e4784a9d0e6d0eddc4de1a8bbe0943b9ebef8b13a18a82a6b9cb1e` (`7138546`).

See `RELEASE_SD_INCLUDED_FILES.txt` (56 files) and `LGPT_R36SX_Bacon-1.5_SHA256SUMS.txt` for per-file hashes. `unzip -t` PASS, `test_release_audio_bootstrap` PASS, H38 only.
