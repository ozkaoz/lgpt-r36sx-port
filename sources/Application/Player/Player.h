...
//	PlayMode GetPlayMode() ;
	...
	bool IsRunning() ;
	bool Clipped() ;
	int GetMasterPeakLeft() ;
	int GetMasterPeakRight() ;
	int GetChannelPeak(int channel) ;
	bool IsChannelClipped(int channel) ;
	...
	double GetPlayTime() ;
      void TreeFrogSoftStopStateOnly();

    bool ExportSongToWav(int renderMode);
    bool BeginSongExportToWav(int renderMode);
    bool ContinueSongExport(int budgetSlices);
    void CancelSongExport();
    bool IsExportingSong() const;
    int GetExportProgressPercent() const;
    int GetExportRenderMode() const;
...
protected:
    ...
    int findFirstSongRow() ;
    int findNextSongRow(int startRow) ;
    int findLastSongRow() ;
    bool hasPlayingChannels() ;
    void finishSongExport(bool ok);
...
private:
    ...
    int offlineSongLastRow_ ;
    bool exportActive_ ;
    bool exportOk_ ;
    int exportRenderMode_ ;
    int exportFirstRow_ ;
    int exportLastRow_ ;
    int exportMaxSlices_ ;
    int exportSlice_ ;
    int exportSaveSongX_ ;
    int exportSaveSongY_ ;
    int exportSaveSongOffset_ ;
    int exportSaveChainRow_ ;
    PlayMode exportSavePlayMode_ ;
    SequencerMode exportSaveSequencerMode_ ;
