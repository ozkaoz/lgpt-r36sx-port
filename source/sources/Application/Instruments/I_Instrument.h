...
#define SIP_EQS3 MAKE_FOURCC('E', 'Q', 'S', '3')
#define SIP_EQS4 MAKE_FOURCC('E', 'Q', 'S', '4')
#define SIP_EQS5 MAKE_FOURCC('E', 'Q', 'S', '5')
#define SIP_EQS6 MAKE_FOURCC('E', 'Q', 'S', '6')
#define SIP_EQS7 MAKE_FOURCC('E', 'Q', 'S', '7')
