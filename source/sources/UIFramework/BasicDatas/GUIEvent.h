...
enum GUIEventType {
    ...
    ET_PADBUTTONDOWN,
    /*
     * TreeFrog atomic-mask events carry the complete logical LGPT button
     * mask in GUIEvent::GetValue().  They remove source-lag composites and
     * per-button dispatch ordering artifacts.
     */
    ET_PADMASKUP,
    ET_PADMASKDOWN,
    ET_PLAYERUPDATE,
...
EPBT_START, 
EPBT_SELECT,
// TREEFROG_INPUT_XY_EVENT_SYMBOLS
EPBT_X = 10,
EPBT_Y = 11,
// TREEFROG_INPUT_L2_R2_RESERVED
EPBT_L2 = 12,
EPBT_R2 = 13 
} ;
